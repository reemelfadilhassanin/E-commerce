// import { facebook } from '../../../public/Assets/exporting'
...
//             <a href="#" className="text-gray-500 hover:scale-120 bg-[#7F288133] rounded-full p-1"><img className=' w-5 h-5 m-2' src={facebook} alt="FaStore"></img></a>
//           </div>
//           </div> 
//         </div>
